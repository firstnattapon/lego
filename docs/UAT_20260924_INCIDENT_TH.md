...
- Offline audit ตรวจ missing terminal quantity, payload/intent mismatch, overfill, identity mismatch และ reject reason gap โดยเก็บเฉพาะยอดรวมและ hash ของ source ในรายงาน
